  ...
  <ModalWrapper :visible="props.visible" @close="emit('close')">
    <div class="code-box">
      ...
      <div class="code-content-box">
        <PerfectScrollbar class="code-scroll-wrapper" :options="{ suppressScrollX: false }">
...
.code-box {
  ...
  margin: 0 auto;
  padding: $code-header-height $code-box-side-padding-normal 2.5rem $code-box-side-padding-normal;
  overflow: hidden;
  ...
  @media screen and (max-width: var.$screen-sm) {
    width: 90%;
    padding: $code-header-height $code-box-side-padding-small 2.5rem $code-box-side-padding-small;
